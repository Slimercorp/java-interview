...
+ [Что такое _«модульное тестирование»_?](#Что-такое-модульное-тестирование) [Junior]
+ [Что такое _«интеграционное тестирование»_?](#Что-такое-интеграционное-тестирование) [Junior]
+ [Чем интеграционное тестирование отличается от модульного?](#Чем-интеграционное-тестирование-отличается-от-модульного) [Junior]
+ [Какие существуют виды тестовых объектов?](#Какие-существуют-виды-тестовых-объектов)[Junior]
+ [Чем _stub_ отличается от _mock_?](#Чем-stub-отличается-от-mock)[Junior]
+ [Что такое _«фикстуры»_?](#Что-такое-фикстуры)[Junior]
+ [Какие аннотации фикстур существуют в JUnit?](#Какие-аннотации-фикстур-существуют-в-junit)[Junior]
+ [Для чего в JUnit используется аннотация `@Ignore`?](#Для-чего-в-junit-используется-аннотация-ignore)[Junior]

## Что такое _«модульное тестирование»_? [Junior]
...
## Что такое _«интеграционное тестирование»_? [Junior]
...
## Чем _stub_ отличается от _mock_? [Junior]
...
## Для чего в JUnit используется аннотация `@Ignore`? [Junior]
