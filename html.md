...
## Что такое `DOCTYPE` и зачем он нужен? [Middle+]
...
## Для чего предназначен тег `<head>`? [Junior]
...
## Чем отличается `<div>` от `<span>`? [Junior]
...
## Как обозначаются комментарии в HTML? [Junior]
...
## Для чего предназначен тег `<em>`? [Junior]
...
## Для чего предназначены теги `<ol>`, `<ul>`, `<li>`? [Junior]
...
## Для чего предназначены теги `<dl>`, `<dt>`, `<dd>`? [Junior]
...
## Для чего предназначены теги `<tr>`, `<th>`, `<td>`? [Junior]
...
## Обязательно ли писать атрибут `alt` в теге `<img>`? [Junior]
...
## В каком регистре лучше писать HTML-код? [Junior]
