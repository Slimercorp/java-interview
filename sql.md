...
## Какие существуют типы `JOIN`? [Junior]
...
## В чем разница между `COUNT(*)` и `COUNT({column})`? [Junior]
...
Для работы с хранимыми процедурами есть свой класс `CallableStatwment`, синтаксис:
